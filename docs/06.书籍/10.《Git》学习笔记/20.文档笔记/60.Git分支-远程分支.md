...
![git fetch</code> 更新你的远程仓库引用。](https://git-scm.com/book/en/v2/images/remote-branches-3.png)
...
![远程跟踪分支 teamone/master</code>。](https://git-scm.com/book/en/v2/images/remote-branches-5.png)
